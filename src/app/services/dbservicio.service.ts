...
export class DbservicioService {
  ...
  tablaViaje: string = "CREATE TABLE IF NOT EXISTS viaje(idviaje INTEGER PRIMARY KEY , nombre VARCHAR (50) , patente VARCHAR (50)  , marca VARCHAR (50) , comuna VARCHAR (50)  , costo INTEGER);";
